    ...
    <section>
        <div class="container mb-5">
            <div class="merchant-details">
                <form action="{{route('rooms.store')}}" method="POST" enctype="multipart/form-data" id="homestay-edit">
{{--                    {{ method_field('PUT') }}--}}
                    @csrf
                        ...
                        <div class="col-lg-8 col-md-7 col-sm-12">
                            <div class="input-group mb-3">
                                <input type="file" class="form-control @error('image') is-invalid @enderror h-min" aria-label="" aria-describedby="basic-addon1"
                                       name="image" onchange="loadPreview(this, '#image')">
                                @error('image')
