                ...
                <div class="col-xl-4 col-md-6">
                    <div class="row home-top-cate-card mt-3 pt-4 pb-3">
                        ...
                        <div class="col-md-6 home-top-cate-items">
                            ...
                            <ul>
                                <li><a href="{{ url('homestay') }}">Services</a></li>
                                <li><a href="{{ url('homestay') }}">Nearby Places</a></li>
                                <li><a href="{{ url('homestay') }}">Gallery</a></li>
                                <li><a href="{{ url('homestay') }}">Nearby Places</a></li>
                                <li><a href="{{ url('homestay') }}">Rating & Review</a></li>
                            </ul>
                        </div>
                    </div>                    
                </div>
